        ...
        if(KeyBindings.guiSkill.isPressed())
        {
            if(FMLClientHandler.instance().getClientPlayerEntity() != null)
            {
                ...
                if(entityPlayer.dimension == DimensionId.SAO_DIMENSION_ID)
                {
                    ...
                    {
                        entityPlayer.openGui(SwordArtOnline.instance, Reference.GUI_SKILL, entityPlayer.worldObj, (int)entityPlayer.posX, (int)entityPlayer.posY, (int)entityPlayer.posZ);
                    }
                }
            }
        }
