package net.teamsao.mcsao.util;
...
public class NBTHelper {
    ...
    {
        return player != null && player.getEntityData() !=null && player.getEntityData().hasKey(keyName);
    }
    ...
    private static void initNBTTagCompound(Entity player)
    {
    ...
    public static int getInt(EntityPlayer player, String name){
        NBTTagCompound entityPlayer = player.getEntityData();
        if(!entityPlayer.hasKey("bedCoordX"))
        {
            setInteger(player, name, 1);
        }
    ...
    public static void setInteger(EntityPlayer player, String keyName, int keyValue)
    {
        NBTTagCompound entityplayer = player.getEntityData();
        entityplayer.setInteger(keyName, keyValue);
    }
