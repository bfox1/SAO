...
public class GuiSaoInGameMenu extends GuiIngameMenu {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(4, this.width / 2 - 50, this.height / 4 + 24 + b0, I18n.format("menu.returnToGame", new Object[0])));
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100, this.height / 4 + 10 + b0, I18n.format("SAO TAB", new Object[0])));
    ...
    protected void actionPerformed(GuiButton p_146284_1_)
    {
        switch (p_146284_1_.id)
        {
            ...
            case 2:
            case 3:
                this.mc.thePlayer.addChatMessage(new ChatComponentText(EnumChatFormatting.DARK_PURPLE + "SAO RULES BITCH"));
            default:
                break;
            case 4:
